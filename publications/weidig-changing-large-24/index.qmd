...
date: "2024-11-22"
description: "The recent increase in large wildfires in the eastern United States makes it crucial to examine the subsequent risk to human life and property. In the eastern US, the wildland–urban interface (WUI), where wildfire risk is greatest, has…"
...
::: {.nw-cite-meta}
**Weidig, N. C.**, Wonkka, C. L., Ivey, M. A. & Donovan, V. M. (2024). *International Journal of Wildland Fire*, vol. 33, no. 12.
:::

[DOI](https://doi.org/10.1071/WF24110){.nw-btn .nw-btn-primary target="_blank"} [BibTeX](cite.bib){.nw-btn .nw-btn-ghost}
