...
[DOI](https://doi.org/10.1371/journal.pone.0277237){.nw-btn .nw-btn-primary target="_blank"} [View PDF](/publications/weidig-goldilocks-principle-22/weidig-goldilocks-principle-22.pdf){.nw-btn .nw-btn-ghost target="_blank"} [BibTeX](cite.bib){.nw-btn .nw-btn-ghost}
