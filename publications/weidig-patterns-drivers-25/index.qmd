...
date: "2025-01-01"
description: "The recent increase in large wildfires in the eastern United States makes it crucial to examine the subsequent risk to human life and property. In the East, the wildland-urban interface (WUI), where wildfire risk is greatest, has expanded…"
categories: ["Thesis"]
pub-authors: "**Weidig, N. C.**"
pub-venue: "University of Florida"
pub-url: "https://original-ufdc.uflib.ufl.edu/files/UFE0062783/00001/Weidig_N.pdf"
---
...
[Source](https://original-ufdc.uflib.ufl.edu/files/UFE0062783/00001/Weidig_N.pdf){.nw-btn .nw-btn-primary target="_blank"} [BibTeX](cite.bib){.nw-btn .nw-btn-ghost}
