...
::: {.nw-cite-meta}
**Weidig, N. C.**, Wonkka, C. L., Ivey, M. A. & Donovan, V. M. (2024). *International Association for Landscape Ecology - North America Annual Conference*.
:::

[Source](https://www.ialena.org/program-2024.html){.nw-btn .nw-btn-primary target="_blank"} [BibTeX](cite.bib){.nw-btn .nw-btn-ghost}
