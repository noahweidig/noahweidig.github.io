...
[DOI](https://doi.org/10.1071/WF24110){.nw-btn .nw-btn-primary target="_blank"} [View PDF](/publications/weidig-changing-large-24-gmcj/weidig-changing-large-24-gmcj.pdf){.nw-btn .nw-btn-ghost target="_blank"} [BibTeX](cite.bib){.nw-btn .nw-btn-ghost}
