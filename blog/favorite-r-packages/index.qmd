...
toc: true
toc-depth: 3
# The R in this post is never executed at render time — the site still builds
# without an R toolchain in CI. Instead the quarto-webr extension turns most
# blocks into live cells that run in the reader's browser via WebAssembly
# (webR). A few blocks that a browser sandbox cannot honestly run (renv,
# benchmarks, reads of real files) stay as static listings.
#
# Those cells are fenced as ```{.r .webr}, not the ```{webr-r} form from the
# extension's README: code-window filters first and rewrites unknown code-block
# languages, which would strip off the class webR keys on. A plain `.r` class
# survives that pass untouched.
#
# `engine: markdown` keeps Quarto from reaching for jupyter or knitr — nothing
# here executes at render time, so CI needs neither R nor Python.
engine: markdown
webr:
  # Nothing is installed up front: a full tidyverse download on page load would
  # be tens of megabytes for every visitor. Packages are fetched on demand by
  # the `webr::install()` calls in the cells themselves.
  packages: []
...
::: {.callout-important}
## The code on this page actually runs

Every cell with a **Run Code** button is a live R session running in *your
browser* — no install, no server, nothing sent anywhere. It is real R compiled
to WebAssembly by [webR](https://docs.r-wasm.org/webr/latest/), wired up with
the [quarto-webr](https://github.com/coatless/quarto-webr) extension. Edit the
code, rerun it, break it, fix it.

Two things to know:

1. **Run the setup cell below first.** All the cells share one R session, and
   the later ones expect `penguins` and the tidyverse to be loaded.
2. **`webr::install()` is a browser-only line.** On your own machine you would
   use `install.packages()` once and forget it; in the browser each package is
   fetched fresh, so the cells that need one ask for it explicitly. The
   tidyverse download is a chunk of megabytes and takes a moment the first
   time.

A few blocks — `renv`, the vroom benchmark, the `conflicted` demo, anything
that reads a real file from disk — are plain listings, because they need a
project, a filesystem, or timings that a browser sandbox cannot honestly give
you.
:::

```{.r .webr}
webr::install(c("tidyverse", "palmerpenguins"))
...
set.seed(42)            # so the random examples below reproduce exactly
```
...
### ggplot2 <img src="logos/ggplot2.webp" alt="ggplot2 hex logo" style="float: right" width="87" height="100" loading="lazy">
...
### dplyr <img src="logos/dplyr.webp" alt="dplyr hex logo" style="float: right" width="87" height="100" loading="lazy">
...
### tidyr <img src="logos/tidyr.webp" alt="tidyr hex logo" style="float: right" width="87" height="100" loading="lazy">
...
### readr <img src="logos/readr.webp" alt="readr hex logo" style="float: right" width="87" height="100" loading="lazy">
...
### purrr <img src="logos/purrr.webp" alt="purrr hex logo" style="float: right" width="87" height="100" loading="lazy">
...
### tibble <img src="logos/tibble.webp" alt="tibble hex logo" style="float: right" width="87" height="100" loading="lazy">
...
### stringr <img src="logos/stringr.webp" alt="stringr hex logo" style="float: right" width="87" height="100" loading="lazy">
...
### forcats <img src="logos/forcats.webp" alt="forcats hex logo" style="float: right" width="87" height="100" loading="lazy">
...
### lubridate <img src="logos/lubridate.webp" alt="lubridate hex logo" style="float: right" width="87" height="100" loading="lazy">
...
- **vctrs** <img src="logos/vctrs.webp" alt="vctrs hex logo" style="float: right" width="61" height="70" loading="lazy">
...
- **rlang** <img src="logos/rlang.webp" alt="rlang hex logo" style="float: right" width="61" height="70" loading="lazy">
...
<img src="logos/ggplot2.webp" alt="ggplot2 hex logo" style="float: right" width="87" height="100" loading="lazy">
...
<img src="logos/readr.webp" alt="readr hex logo" style="float: right" width="87" height="100" loading="lazy">
...
<img src="logos/purrr.webp" alt="purrr hex logo" style="float: right" width="87" height="100" loading="lazy">
...
<img src="logos/lubridate.webp" alt="lubridate hex logo" style="float: right" width="87" height="100" loading="lazy">
...
### fs <img src="logos/fs.webp" alt="fs hex logo" style="float: right" width="87" height="100" loading="lazy">
...
### glue <img src="logos/glue.webp" alt="glue hex logo" style="float: right" width="87" height="100" loading="lazy"> {#glue}
...
### vroom <img src="logos/vroom.webp" alt="vroom hex logo" style="float: right" width="89" height="100" loading="lazy"> {#vroom}
...
### renv <img src="logos/renv.svg" alt="renv hex logo" style="float: right" width="100" height="100" loading="lazy">
...
### insight <img src="logos/insight.webp" alt="insight hex logo" style="float: right" width="86" height="100" loading="lazy">
...
### parameters <img src="logos/parameters.webp" alt="parameters hex logo" style="float: right" width="86" height="100" loading="lazy">
...
```{.r .webr}
webr::install("parameters")
library(parameters)

model_parameters(model)
```

### performance <img src="logos/performance.webp" alt="performance hex logo" style="float: right" width="86" height="100" loading="lazy">
...
### effectsize <img src="logos/effectsize.webp" alt="effectsize hex logo" style="float: right" width="86" height="100" loading="lazy">
...
### correlation <img src="logos/correlation.webp" alt="correlation hex logo" style="float: right" width="86" height="100" loading="lazy">
...
### datawizard <img src="logos/datawizard.webp" alt="datawizard hex logo" style="float: right" width="86" height="100" loading="lazy">
...
### modelbased <img src="logos/modelbased.webp" alt="modelbased hex logo" style="float: right" width="86" height="100" loading="lazy">
...
```{.r .webr}
webr::install("modelbased")
library(modelbased)

estimate_means(model, by = "species")
```

### bayestestR <img src="logos/bayestestR.webp" alt="bayestestR hex logo" style="float: right" width="86" height="100" loading="lazy">
...
### see <img src="logos/see.webp" alt="see hex logo" style="float: right" width="86" height="100" loading="lazy">
...
### report <img src="logos/report.webp" alt="report hex logo" style="float: right" width="86" height="100" loading="lazy">
...
### ggdist <img src="logos/ggdist.svg" alt="ggdist hex logo" style="float: right" width="86" height="100" loading="lazy">
...
### patchwork <img src="logos/patchwork.webp" alt="patchwork hex logo" style="float: right" width="87" height="100" loading="lazy">
...
### cowplot <img src="logos/cowplot.webp" alt="cowplot hex logo" style="float: right" width="87" height="100" loading="lazy">
