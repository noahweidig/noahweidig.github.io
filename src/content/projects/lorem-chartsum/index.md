...
links:
  - label: 'See API'
    href: 'https://noahweidig.com/lorem-chartsum'
    variant: primary
    external: true
---

<img src="../../media/albums/projects/lorem-chartsum.webp" alt="A placeholder chart generated by the Lorem Chartsum API" width="1600" height="1000" loading="lazy" decoding="async">
