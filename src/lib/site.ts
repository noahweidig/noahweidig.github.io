export const site = {
  ...
  // Generated by `npm run covers -- --site` (scripts/generate-blog-covers.mjs),
  // same branded card design as blog post covers, instead of a personal photo.
  ogImage: '/media/authors/site-og.webp',
